...
<body>
	...
	<?php
		...
		// 	while (($row == $statement->fetch(PDO::FETCH_ASSOC)) AND ($row == $statement2->fetch(PDO::FETCH_ASSOC)) AND ($row == $statement3->fetch(PDO::FETCH_ASSOC))) {
	...
	try {
		...
		try {
		  ...
		  try {
			  ...
			  echo "<h5>Emailaddress: </h5>";
			  echo "<br>";
			  echo "<p> $emailaddress </p>";
			  
			  echo "<h5>Sunday Date: </h5>";
			  echo "<br>";
			  echo "<p> $sundaydate </p>";
			  echo "<br>";
